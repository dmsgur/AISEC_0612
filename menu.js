...
menu1.url = "?menu=1"
menu1.tips = ["2.1 ", "2.2 회귀예측 모델 구성 및 훈련 평가", "1.3 코드 리팩토링", "1.4 플라스크 미들웨어 구현", "1.5 사용자 UI 구현", "1.6 로또 예측 서비스 구동"]
menu2 = new Menu("1. 네이버 쇼핑상품리뷰 감성 이진분류 예측")//1. 개발목적/언어-선정/요구사항명세/분석 2. 구현도구/라이센스 3. 테스트도구(junit,mockobj)  4. 형상관리도구  5. 빌드도구
menu2.url = "?menu=2"
menu2.tips = ["3.1 ", "3.2 회귀예측 모델 구성 및 훈련 평가", "1.3 코드 리팩토링", "1.4 플라스크 미들웨어 구현", "1.5 사용자 UI 구현", "1.6 로또 예측 서비스 구동"]
